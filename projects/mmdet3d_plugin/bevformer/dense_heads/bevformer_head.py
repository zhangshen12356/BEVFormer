...
class BEVFormerHead(DETRHead):
    ...
    def forward(self, mlvl_feats, img_metas, prev_bev=None,  only_bev=False):
        ...
        '''
        self.query_embedding = nn.Embedding(self.num_query, self.embed_dims * 2) Embedding(900, 512)
        '''
        ...
        if only_bev:  # only use encoder to obtain BEV features, TODO: refine the workaround
            return self.transformer.get_bev_features( # 在transformer.py中的第106行
                mlvl_feats,
                bev_queries,
                self.bev_h,
                self.bev_w,
